...
```bash
DEMO_OTP_EMAIL=demo@sanad.test
DEMO_OTP_CODE=123456
```

عندها يدخل العميل بالإيميل المحدد، ويستخدم الكود `123456`، ثم يكمل بيانات
الحساب. احذف المتغيرين قبل تحويل التطبيق إلى `production`.
